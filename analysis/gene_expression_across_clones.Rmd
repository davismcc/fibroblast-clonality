---
title: "Expression of genes across multiple clones"
...
ggsave("figures/gene_expression_across_clones/joxm_highexprs_normdistn_genes.png", 
       height = 7, width = 13, plot = p3)
ggsave("figures/gene_expression_across_clones/joxm_highexprs_normdistn_genes.pdf", 
       height = 7, width = 13, plot = p3)
```
...
ggsave("figures/gene_expression_across_clones/joxm_highexprs_activation_genes.png", 
       height = 7, width = 13, plot = p6)
ggsave("figures/gene_expression_across_clones/joxm_highexprs_activation_genes.pdf", 
       height = 7, width = 13, plot = p6)
...
ggplot(aes(x = variance, y = gene, color = population)) +
  geom_point(size = 3) +
  scale_colour_manual(values = c("gray60", "firebrick3", "goldenrod3")) +
  theme_bw()
```
...
ggplot(aes(x = variance, y = gene, fill = population)) +
  geom_point(size = 3, colour = "gray40", pch = 21, alpha = 0.6) +
  scale_fill_manual(values = c("gray60", "firebrick3", "goldenrod3")) +
  xlab("Expression variance") +
  ylab("Gene") +
  theme_bw()
p1
...
p3 <- plot_grid(p2, p1, labels = "auto", nrow = 1)
ggsave("figures/gene_expression_across_clones/vass_highexprs_normdistn_genes.png", 
       height = 7, width = 13, plot = p3)
ggsave("figures/gene_expression_across_clones/vass_highexprs_normdistn_genes.pdf", 
       height = 7, width = 13, plot = p3)
```
...
p3 <- plot_grid(p2, p1, labels = "auto", nrow = 1)
ggsave("figures/gene_expression_across_clones/zoxy_highexprs_normdistn_genes.png", 
       height = 7, width = 13, plot = p3)
ggsave("figures/gene_expression_across_clones/zoxy_highexprs_normdistn_genes.pdf", 
       height = 7, width = 13, plot = p3)
```
