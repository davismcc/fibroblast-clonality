...
ggsave("figures/differential_expression/n_sig_genesets_N_de_genes_vs_n_cells_2panel_facet_by_num_clones.png", 
       height = 10.5, width = 9.5, plot = pp)
ggsave("figures/differential_expression/n_sig_genesets_N_de_genes_vs_n_cells_2panel_facet_by_num_clones.pdf", 
       height = 10.5, width = 9.5, plot = pp)
ggsave("figures/differential_expression/n_sig_genesets_N_de_genes_vs_n_cells_2panel_facet_by_num_clones.svg", 
       height = 10.5, width = 9.5, plot = pp)
